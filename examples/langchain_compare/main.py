...
class ToolExecutor:
    ...
    async def execute(self, tool_name: str, args: Dict[str, Any]) -> str:
        ...
        if tool_name == "read_materials":
            ...
            return await self._generate_report(args.get("topic", ""), args.get("format", "standard"))
        elif tool_name == "polish_text":
            return await self._polish_text(args.get("text", ""), args.get("style", "professional"))
        else:
    ...
    async def _read_materials(self, file_types: str) -> str:
        ...
        result = {"success": True, "total_files": len(materials), "materials": materials}
...
async def main():
    ...
    if result.get("success"):
        ...
        output_file.write_text(f"""# OpenAI Function Calling 研究报告
