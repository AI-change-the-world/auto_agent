...
TOOLS_SCHEMA = [
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "project_name": {"type": "string", "description": "项目名称（英文，snake_case）"}
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "project_type": {"type": "string", "description": "项目类型: api/web/cli", "default": "api"}
                },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "filename": {"type": "string", "description": "文件名 (如 models.py)"},
                    "code_type": {"type": "string", "enum": ["models", "service", "router", "tests"], "description": "代码类型"}
                },
...
请直接输出 Python 代码，用 ```python 和 ``` 包裹。"""
    ...
    return {"success": True, "model_names": model_names, "line_count": len(code.split("\n"))}
...
请直接输出 Python 代码，用 ```python 和 ``` 包裹。"""
    ...
    return {"success": True, "service_methods": methods, "line_count": len(code.split("\n"))}
...
请直接输出 Python 代码，用 ```python 和 ``` 包裹。"""
    ...
    return {"success": True, "route_count": route_count, "line_count": len(code.split("\n"))}
...
请直接输出 Python 代码，用 ```python 和 ``` 包裹。"""
    ...
    return {"success": True, "test_count": test_count, "line_count": len(code.split("\n"))}
...
"""
    ...
    try:
        ...
        return {
            ...
            "output_dir": str(output_dir / project_name) if _g.project_dir else str(output_dir),
...
async def main():
    ...
    if result.get("success"):
        ...
        for step in result.get("token_steps", []):
            token_detail += f"| {step['step']} | {step['tokens']:,} | {step['cumulative']:,} |\n"
        
        report_file.write_text(f"""# LangChain 风格全栈项目生成报告
